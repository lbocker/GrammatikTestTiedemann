...
final class Version20240414130727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz ADD points INT DEFAULT 0 NOT NULL, CHANGE question question VARCHAR(255) NOT NULL, CHANGE right_answer right_answer JSON NOT NULL, CHANGE wrong_answer wrong_answer JSON NOT NULL, CHANGE type type VARCHAR(255) NOT NULL');
