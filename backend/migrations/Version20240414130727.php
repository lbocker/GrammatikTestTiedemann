...
final class Version20240414130727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_courses_status (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(255) NOT NULL, courses_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_4FAC2F335359E06E (courses_id), INDEX IDX_4FAC2F339D86650F (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE quiz ADD points INT DEFAULT 0 NOT NULL, CHANGE question question VARCHAR(255) NOT NULL, CHANGE right_answer right_answer TEXT NOT NULL, CHANGE wrong_answer wrong_answer TEXT NOT NULL, CHANGE type type VARCHAR(255) NOT NULL');
